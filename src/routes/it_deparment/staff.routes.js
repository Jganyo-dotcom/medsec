...
router.patch("/disable-staff/:id",authmiddleware, disableStaff); // disable staff
router.put("/edit-staff/:id",authmiddleware, editStaffById); // edit staff
router.patch("/reset-staff-password/:id",authmiddleware, resetStaffPassword); // reset staff password
